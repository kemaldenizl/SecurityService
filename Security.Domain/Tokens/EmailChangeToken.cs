...
public sealed class EmailChangeToken : ITenantScoped
{
        ...
        DateTime createdAtUtc)
    {
        ...
        Guard.Against(expiresAtUtc <= createdAtUtc, "Email change token expiry must be after creation time.");
    }
    ...
    public void MarkUsed(DateTime utcNow)
    {
        ...
        Guard.Against(Used, "Email change token is already used.");

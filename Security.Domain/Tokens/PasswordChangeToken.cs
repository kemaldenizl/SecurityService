...
public sealed class PasswordChangeToken : ITenantScoped
{
        ...
        DateTime createdAtUtc)
    {
        ...
        Guard.Against(expiresAtUtc <= createdAtUtc, "Password change token expiry must be after creation time.");
    }
    ...
    public void MarkUsed(DateTime utcNow)
    {
        ...
        Guard.Against(Used, "Password change token is already used.");
